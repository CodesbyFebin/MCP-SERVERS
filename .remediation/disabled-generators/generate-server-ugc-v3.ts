...
function generateAllPages(dryRun = false) {
  console.log(`[server-ugc-v3] ${dryRun ? "Dry run" : "Generating"} 2000+ word UGC content for servers...`);
...
`;
    ...
    generated++;
    if (generated % 10 === 0) {
      console.log(`[server-ugc-v3] Generated ${generated} pages...`);
    }
  }

  console.log(`[server-ugc-v3] ${dryRun ? "Would generate" : "Generated"} ${generated} server UGC pages`);
}

...
export function generateHomepageLd(serverCount, integrationCount, categoryCount, recentExecutions) {
    return [
        // Organization schema
...
export function generateServersLd(serverEntries) {
    return [
        schemas.website,
        {
            "@context": "https://schema.org",
...
export function generateServerLd(server, publicationDecision) {
    const base = {
        "@context": "https://schema.org",
        "@type": "SoftwareApplication",
        "name": server.name,
...
export function generateIntegrationsLd(integrationEntries) {
    return [
        schemas.website,
        {
            "@context": "https://schema.org",
...
export function generateClientsLd(clientEntries) {
    return [
        schemas.website,
        {
            "@context": "https://schema.org",
...
export function generateEvidenceLd(evidenceEntries) {
    return [
        schemas.website,
        {
            "@context": "https://schema.org",
...
export function generateDocsLd(docsEntries) {
...
export function generateGlossaryLd(termEntries) {
    return [
        schemas.website,
        {
            "@context": "https://schema.org",
